...
TEST_CASE( "vehicle_efficiency", "[vehicle] [engine]" )
{
    ...
    test_vehicle( "electric_car_test", 774098, 185761, 145527, 14550, 11192 );
    test_vehicle( "suv_test", 1220297, 1163000, 656294, 88100, 35099 );
    ...
    test_vehicle( "ambulance_test", 1722821, 613400, 507665, 78448, 65786 );
    test_vehicle( "fire_engine_test", 2125865, 1938615, 1833894, 395362, 391612 );
    test_vehicle( "fire_truck_test", 6188273, 410700, 83850, 19080, 4432 );
    ...
    test_vehicle( "car_test", 1020629, 76060, 76060, 45498, 27378, 0, 0, true );
    test_vehicle( "car_sports_test", 1052382, 353200, 272005, 36592, 23455, 0, 0, true );
    test_vehicle( "electric_car_test", 774098, 186356, 145994, 14579, 11216, 0, 0, true );
    test_vehicle( "suv_test", 1220297, 112000, 111800, 66880, 33192, 0, 0, true );
    ...
    test_vehicle( "humvee_test", 5346601, 89850, 90100, 25690, 17087, 0, 0, true );
